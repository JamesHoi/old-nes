    ...
    while (1) {
        ...
        switch (gameState) {
            ...
            case GAME_STATE_CREDITS:
                ...
                while(flagIndex != MAX_FLAG_LENGHT){
                    banked_call(PRG_BANK_MENU_DRAW_TEXT, draw_mrctf_text);
                    banked_call(PRG_BANK_MENU_INPUT_TEXT, wait_for_text);
                    banked_call(PRG_BANK_MENU_CHECK_FLAG, check_flag);
                }
                fade_out();
